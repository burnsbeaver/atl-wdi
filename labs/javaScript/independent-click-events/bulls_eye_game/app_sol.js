// ** BULLSEYE ** // STEP 1:  Add click handlers to update the score to be:
//     100 points - Bullseye           50 points - Middle Ring           10
// points - Outer Ring            0 points - Miss  (done for you) STEP 2: Break
// down the updateScore method, write a paragraph or comment how the function
// works line by line STEP 3:  Highlight the element that was clicked on using
// the CSS `background-color: yellow` BONUS:  Implement setTimeout so the
// background is yellow for only two seconds EXPLORATION: Comment out
// event.stopPropagation in each function, and then click the inner ring. What
// happens?
...
var bullseyeGame = {
  ...
  miss: function (event) {
    ...
    // [ALERT:] needs to be bullseyeGame because this in clickEvents refers to the
